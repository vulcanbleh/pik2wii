#ifndef REVOSDK_PRIVATE_IOSTYPES_H
#define REVOSDK_PRIVATE_IOSTYPES_H
...
typedef enum { IOSC_SIG_RSA4096 = 0x00010000, IOSC_SIG_RSA2048, IOSC_SIG_ECC } IOSCCertSigType;
