...
namespace nw4hbm { namespace lyt
{
	namespace res
	{
		static byte4_t const SIGNATURE_PICTURE_BLOCK =
			NW4HBM_FOUR_CHAR('p', 'i', 'c', '1');

		// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_picture.o(1)::.debug_info::0x102d [original object]
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_picture.o(1)::.debug_info::0x222 [original object]
