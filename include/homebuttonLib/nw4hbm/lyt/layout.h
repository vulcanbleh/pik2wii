...
namespace nw4hbm { namespace lyt
{
	namespace res
	{
		static byte4_t const SIGNATURE_LAYOUT_BLOCK =
			NW4HBM_FOUR_CHAR('l', 'y', 't', '1');

		// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_layout.o(1)::.debug_info::0x14d7 [original object]
		struct Layout
		{
		...
		static byte4_t const SIGNATURE_TEXTURE_LIST_BLOCK =
			NW4HBM_FOUR_CHAR('t', 'x', 'l', '1');

		// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_layout.o(1)::.debug_info::0x1387 [original object]
		struct TextureList
		{
			DataBlockHeader	blockHeader;	// size 0x08, offset 0x00
		...
		static byte4_t const SIGNATURE_FONT_LIST_BLOCK =
			NW4HBM_FOUR_CHAR('f', 'n', 'l', '1');

		// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_layout.o(1)::.debug_info::0x13e8 [original object]
		struct FontList
		{
			DataBlockHeader	blockHeader;	// size 0x08, offset 0x00
		...
		static byte4_t const SIGNATURE_MATERIAL_LIST_BLOCK =
			NW4HBM_FOUR_CHAR('m', 'a', 't', '1');

		// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_layout.o(1)::.debug_info::0x1447 [original object]
		struct MaterialList
		{
			DataBlockHeader	blockHeader;	// size 0x08, offset 0x00
		...
		static byte4_t const SIGNATURE_LAYOUT =
			NW4HBM_FOUR_CHAR('R', 'L', 'Y', 'T');
	} // namespace res

	// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_layout.o(1)::.debug_info::0x1314 [original object]
	struct ResBlockSet
	{
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_layout.o(1)::.debug_info::0xf20 [original object]
	class Layout
	{
	// enums
	public:
