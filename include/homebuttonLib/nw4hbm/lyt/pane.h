...
namespace nw4hbm { namespace lyt
{
	...
	namespace res
	{
		static byte4_t const SIGNATURE_PANE_BLOCK =
			NW4HBM_FOUR_CHAR('p', 'a', 'n', '1');

		static byte4_t const SIGNATURE_PANE_START_BLOCK =
			NW4HBM_FOUR_CHAR('p', 'a', 's', '1');
		static byte4_t const SIGNATURE_PANE_END_BLOCK =
			NW4HBM_FOUR_CHAR('p', 'a', 'e', '1');

		// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_pane.o(1)::.debug_info::0xbcf [original object]
		struct Pane
		{
			DataBlockHeader	blockHeader;	// size 0x08, offset 0x00
			byte1_t			flag;			// size 0x01, offset 0x08
	...
	namespace detail
	{
		// [SC5PGN]/build/libs/Debug/slamWiiD.a:HBMAnmController.o(1)::.debug_info::0x653 [original object]
		struct PaneLink
		{
		// typedefs
		public:
		...
		// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_pane.o(1)::.debug_info::0x4de [original object]
		class PaneBase
		{
		// typedefs
		public:
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_pane.o(1)::.debug_info::0x5bf [original object]
	...
	protected: // Bounding::DrawSelf
		...
		byte1_t					mFlag;				// size 0x01, offset 0xcf
