...
protected:
    math::MTX34 mMtxArray[MTX_TYPE_MAX];  	// _0C
    math::AABB mAABB[BOUNDINGVOLUME_MAX]; 	// _9C

private:
    u32 mScnObjFlags;               		// _CC
    u8 mPriorityDrawOpa;            		// _D0
    u8 mPriorityDrawXlu;            		// _D1
    u8 PADDING_0xD2;                		// _D2
    u8 PADDING_0xD3;                		// _D3
    IScnObjCallback* mpFuncObjExec; 		// _D4
    u8 mCallbackTiming;             		// _D8
    u8 mCallbackDeleteOption;       		// _D9
    u16 mCallbackExecOpMask;        		// _DA
...
public:
    virtual ~IScnObjGather() {} 										// _08
    virtual CullingStatus Add(ScnObj* pObj, bool opa, bool xlu) = 0; 	// _0C
    virtual void Clear() = 0;                                        	// _10
    virtual void ZSort() = 0;                                        	// _14
    virtual void Sort() = 0; 											// _18
    virtual void Sort(LessThanFunc pOpaFunc,
                      LessThanFunc pXluFunc) = 0; 						// _1C
    virtual void DrawOpa(ResMdlDrawMode* pForceMode) = 0; 				// _20
    virtual void DrawXlu(ResMdlDrawMode* pForceMode) = 0; 				// _24
};
...
class IScnObjCallback {
public:
    virtual ~IScnObjCallback() {} 													// _08
    virtual void ExecCallback_CALC_WORLD(ScnObj::Timing, ScnObj*, u32, void*) {} 	// _0C
    virtual void ExecCallback_CALC_MAT(ScnObj::Timing, ScnObj*, u32, void*) {} 		// _10
    virtual void ExecCallback_CALC_VIEW(ScnObj::Timing, ScnObj*, u32, void*) {} 	// _14
    virtual void ExecCallback_DRAW_OPA(ScnObj::Timing, ScnObj*, u32, void*) {} 		// _18
    virtual void ExecCallback_DRAW_XLU(ScnObj::Timing, ScnObj*, u32, void*) {} 		// _1C
};
...
void ScnObj::CheckCallback_CALC_VIEW(Timing timing, u32 param, void* pInfo) {
    if (mpFuncObjExec != nullptr && (mCallbackExecOpMask & EXECOP_CALC_VIEW) &&
...
void ScnObj::CheckCallback_CALC_MAT(Timing timing, u32 param, void* pInfo) {
    if (mpFuncObjExec != nullptr && (mCallbackExecOpMask & EXECOP_CALC_MAT) &&
        (mCallbackTiming & timing)) {
...
void ScnObj::CheckCallback_CALC_WORLD(Timing timing, u32 param, void* pInfo) {
    if (mpFuncObjExec != nullptr && (mCallbackExecOpMask & EXECOP_CALC_WORLD) &&
        (mCallbackTiming & timing)) {
...
void ScnObj::CheckCallback_DRAW_OPA(Timing timing, u32 param, void* pInfo) {
    if (mpFuncObjExec != nullptr && (mCallbackExecOpMask & EXECOP_DRAW_OPA) &&
        (mCallbackTiming & timing)) {
...
void ScnObj::CheckCallback_DRAW_XLU(Timing timing, u32 param, void* pInfo) {
    if (mpFuncObjExec != nullptr && (mCallbackExecOpMask & EXECOP_DRAW_XLU) &&
        (mCallbackTiming & timing)) {
...
public:
    ...
    virtual ~ScnGroup();                                    		// _10
    virtual ForEachResult ForEach(ForEachFunc pFunc, void* pInfo,
                                  bool postOrder); 					// _1C
    virtual bool Insert(u32 idx, ScnObj* pObj); 					// _34
    virtual ScnObj* Remove(u32 idx);            					// _38
    virtual bool Remove(ScnObj* pObj);          					// _3C
