#include "RevoSDK/bte/bta_ag_int.h"
...
#include "RevoSDK/bte/bta_ag_api.h"
...
#define BTA_AG_CIND_INFO                                                      \
	"(\"call\",(0,1)),(\"callsetup\",(0-3)),(\"service\",(0,1)),(\"signal\"," \
	"(0-5)),(\"roam\",(0,1)),(\"battchg\",(0-5)),(\"callheld\",(0-2))"

#ifndef BTA_AG_CIND_INFO
# define BTA_AG_CIND_INFO                                                      \
	 "(\"call\",(0,1)),(\"callsetup\",(0-3)),(\"service\",(0-3)),(\"signal\"," \
	 "(0-6)),(\"roam\",(0,1)),(\"battchg\",(0-5)),(\"callheld\",(0-2)),("      \
	 "\"bearer\",(0-7))"
#endif
...
#define BTA_AG_SCO_PKT_TYPES	0x3f
