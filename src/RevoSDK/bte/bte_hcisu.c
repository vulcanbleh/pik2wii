...
#include "RevoSDK/bte/data_types.h" // UINT16
#include "RevoSDK/bte/gki_target.h" // BTU_TASK

#include "RevoSDK/bte/btu.h" // BTU_HCI_RCV_MBOX
#include "RevoSDK/bte/gki.h"
#include "RevoSDK/bte/hci.h"
