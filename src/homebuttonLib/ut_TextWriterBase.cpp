...
template <typename CharT>
void TextWriterBase<CharT>::SetDrawFlag(byte4_t flags)
{
	mDrawFlag = flags;
}

template <typename CharT>
byte4_t TextWriterBase<CharT>::GetDrawFlag() const
{
	return mDrawFlag;
}
...
template <typename CharT>
f32 TextWriterBase<CharT>::CalcFormatStringHeight(CharT const *format,
                                                  ...) const
{
	Rect rect;
	va_list vargs;
...
template <typename CharT>
void TextWriterBase<CharT>::CalcStringRectImpl(Rect *pRect, CharT const *str,
                                               int length)
{
	int remain = length;
	CharT const *pos = str;
...
template <typename CharT>
int TextWriterBase<CharT>::CalcLineRectImpl(Rect *pRect, CharT const *str,
                                            int length)
{
...
template <typename CharT>
f32 TextWriterBase<CharT>::VPrintf(CharT const *format, va_list args)
{
